							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button onclick="del()" type="button" class="btn btn-default" title="删除">
										...
										<tr>
											...
											<%--	<button type="button" class="btn bg-olive btn-xs">订单</button>
												...
												<button type="button" class="btn bg-olive btn-xs"
														onclick="location.href='${pageContext.request.contextPath}/product/edit.do?id=${product.id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
